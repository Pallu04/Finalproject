...
import com.accidentalspot.spot.services.GeofenceRegistrationService;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng latLng = new LatLng(19.971782, 73.758294);
        googleMap.addMarker(new MarkerOptions().position(latLng).title("Cidco ,Nashik, Maharashtra"));
